    ...
    <div>
      ...
      <div className="relative flex flex-col gap-8">
        ...
        <div className="relative w-full">
          <div className="relative flex flex-col items-center px-4 py-6 w-full max-w-screen-xl h-auto left-1/2 -translate-x-1/2 bg-white">
            <div className="flex flex-col lg:flex-row justify-center items-center gap-6 lg:gap-15 w-full max-w-full h-auto">
              <div className="flex flex-col items-start gap-4 w-full lg:w-[394px] h-auto">
                <div className="flex flex-col items-start gap-3 w-full h-auto">
                  <p className="text-[14px] leading-[20px] font-normal tracking-[0.2px] text-[#E74040]">
                    Problems trying
                  </p>

                  <h2 className="w-full text-[24px] leading-[32px] font-bold tracking-[0.1px] text-[#252B42]">
              ...
              <div className="flex flex-col items-start gap-3 w-full lg:w-[529px] h-auto">
                <p className="text-[14px] leading-[20px] font-normal tracking-[0.2px] text-[#737373]">
        ...
        <div className="relative flex flex-col items-center bg-white py-10 lg:py-20 px-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 max-w-[1050px]">
            <div className="flex flex-col items-center text-center">
              ...
              <h5 className="text-[16px] font-semibold text-[#737373]">
                Happy Customers
              </h5>
            </div>

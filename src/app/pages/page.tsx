    ...
    <div className="relative">
      ...
      <div className="container relative mx-auto px-4 py-12 flex flex-col md:flex-row gap-8 font-Montserrat">
        ...
        <div className="flex-1">
          ...
          <h6 className="text-sm text-[#737373] mt-2 leading-[24px] tracking-[0.2px]">
            Availability:{" "}
            <span className="text-[#23A6F0] font-bold leading-[24px] tracking-[0.2px]">In Stock</span>
          </h6>

          <p className="text-[#858585] font-normal mt-4">
          ...
          <div className="mt-6">
            ...
            <div className="flex items-center gap-2 mt-2">
              ...
              <span className="h-6 w-6 rounded-full bg-[#252B42] border-gray-300 cursor-pointer"></span>
            </div>
          </div>
